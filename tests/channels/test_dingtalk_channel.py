...
try:
    from openhire.channels import dingtalk
...
import openhire.channels.dingtalk as dingtalk_module
from openhire.channels.dingtalk import DingTalkChannel, NanobotDingTalkHandler
from openhire.channels.dingtalk import DingTalkConfig
...
async def test_download_dingtalk_file(tmp_path, monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "openhire.config.paths.get_media_dir",
