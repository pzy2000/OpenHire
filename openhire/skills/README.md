...
This directory contains built-in skills that extend OpenHire's capabilities.
...
When skills reference large local documentation or logs, prefer OpenHire's built-in
