...
from openhire.cron.types import CronJob, CronJobState, CronPayload, CronRunRecord, CronSchedule, CronStore
                ...
                for j in data.get("jobs", []):
                    jobs.append(CronJob(
                        ...
                        payload=CronPayload(
                            ...
                            employee_id=j["payload"].get("employeeId") or j["payload"].get("employee_id"),
            ...
            "jobs": [
                {
                    ...
                    "payload": {
                        ...
                        "employeeId": j.payload.employee_id,
