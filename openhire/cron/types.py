...
class CronPayload:
    ...
    message: str = ""
    # Optional digital employee owner for OpenHire employee-scoped scheduled work
...
class CronJob:
    ...
    def from_dict(cls, kwargs: dict):
        ...
        if "employeeId" in payload_kwargs and "employee_id" not in payload_kwargs:
            payload_kwargs["employee_id"] = payload_kwargs.pop("employeeId")
