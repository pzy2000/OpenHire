...
class ThinkingSpinner:
    """Spinner that shows 'openhire is thinking...' with pause support."""

    def __init__(self, console: Console | None = None):
        c = console or _make_console()
        self._spinner = c.status("[dim]openhire is thinking...[/dim]", spinner="dots")
        self._active = False
...
class StreamRenderer:
    ...
    async def on_delta(self, delta: str) -> None:
        ...
        if self._live is None:
            ...
            c = _make_console()
            c.print()
            c.print(f"[cyan]{__logo__} openhire[/cyan]")
