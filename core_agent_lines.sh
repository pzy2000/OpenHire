...
echo "OpenHire line count"
echo "=================="
echo ""

echo "Core runtime"
echo "------------"
core_agent=$(count_top_level_py_lines "OpenHire/agent")
core_bus=$(count_top_level_py_lines "OpenHire/bus")
core_config=$(count_top_level_py_lines "OpenHire/config")
core_cron=$(count_top_level_py_lines "OpenHire/cron")
core_heartbeat=$(count_top_level_py_lines "OpenHire/heartbeat")
core_session=$(count_top_level_py_lines "OpenHire/session")
...
echo "----------------"
extra_tools=$(count_recursive_py_lines "OpenHire/agent/tools")
extra_skills=$(count_skill_lines "OpenHire/skills")
extra_api=$(count_recursive_py_lines "OpenHire/api")
extra_cli=$(count_recursive_py_lines "OpenHire/cli")
extra_channels=$(count_recursive_py_lines "OpenHire/channels")
extra_utils=$(count_recursive_py_lines "OpenHire/utils")
...
echo "Notes"
echo "-----"
echo "  - agent/ only counts top-level Python files under OpenHire/agent"
echo "  - tools/ is counted separately from OpenHire/agent/tools"
echo "  - skills/ counts .md, .py, and .sh files"
echo "  - not included here: command/, providers/, security/, templates/, OpenHire.py, root files"
